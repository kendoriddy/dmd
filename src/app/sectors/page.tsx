    ...
    <main className="px-4 py-16 md:px-6 md:py-24">
      <div className="mx-auto max-w-6xl">
        ...
        <div ref={ref} className="relative mt-20 space-y-24">
          <motion.div
            className="absolute left-4 top-0 hidden h-full w-px origin-top bg-white/10 md:block lg:left-0"
          ...
          <SectorBlock
            ...
            bullets={[
              ...
              "Japan–Africa synergy: Japanese agricultural innovation on West African soil.",
            ]}
          />
          <SectorBlock
            icon={SunMedium}
  ...
  return (
    <div className="relative mt-8">
      <button
        type="button"
        onClick={() => scrollBy(-1)}
        className="absolute left-0 top-1/2 z-10 hidden -translate-y-1/2 rounded-full border border-white/20 bg-charcoal/90 p-2 text-silver-200 shadow-lg hover:border-growth md:block"
      ...
      <button
        type="button"
        onClick={() => scrollBy(1)}
        className="absolute right-0 top-1/2 z-10 hidden -translate-y-1/2 rounded-full border border-white/20 bg-charcoal/90 p-2 text-silver-200 shadow-lg hover:border-growth md:block"
      ...
      >
        {cards.map((card, i) => (
          <motion.div
            ...
            className="min-w-[280px] max-w-[300px] shrink-0 snap-start rounded-2xl border border-white/10 bg-gradient-to-b from-charcoal to-charcoal-deep p-6 shadow-[0_0_40px_rgba(31,138,101,0.08)]"
          >
